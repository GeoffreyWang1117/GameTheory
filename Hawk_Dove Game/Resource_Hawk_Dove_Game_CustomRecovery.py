...
def main():
    ...
    renewable_recovery_amount = float(input("请输入每代可再生资源的恢复量: "))
    ...
    population.evolve(V, C, mutation_rate, num_generations, initial_resource, renewable_resource_percent, non_renewable_resource_percent, renewable_recovery_amount)
